...
# Cross NUMAs
PARAM="-W 1 -N 20"
LMBENCH_SCHED="CUSTOM_SPREAD 0 24" ${CMD} ${PARAM}  # NUMA0 - NUMA1
LMBENCH_SCHED="CUSTOM_SPREAD 0 64" ${CMD} ${PARAM}  # NUMA0 - NUMA2, Caution: 0 48 doesn't spread as expected; but 0 64 can.
LMBENCH_SCHED="CUSTOM_SPREAD 0 72" ${CMD} ${PARAM}  # NUMA0 - NUMA3
